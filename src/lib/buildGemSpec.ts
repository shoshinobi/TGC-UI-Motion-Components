...
const audio = {
  ...
  c.musicTrack === 'off'
    ? ''
    : `
// --- soundtrack, volume ${c.musicVolume}, ${c.musicLoop ? 'loop' : 'once'}, starts on ${c.musicStart}${c.musicStart === 'lock' ? ` +${c.musicLockDelay}s` : ''} ---
const MUSIC = ['music-belt-and-braces', 'music-chasing-quails']
