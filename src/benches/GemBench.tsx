    ...
    'scale + punch': folder(
      {
        ...
        punchStiffness: { value: D.punchStiffness, min: 40, max: 1200, step: 10, label: 'punch stiffness' },
        punchDamping: { value: D.punchDamping, min: 2, max: 60, step: 1, label: 'punch damping' },
